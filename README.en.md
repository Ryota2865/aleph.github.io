...
- Assurance: tests: NOT_RECORDED; latest recorded formal audit: PASS (reports/PHASE6_CHANGELOG_VERSION_ORDER_AUDIT_20260725.md); currency: NEEDS_AUDIT; artifacts retained: 35.
- Design state: changelog 0.7.20-37; poetics v1.
