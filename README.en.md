...
- Assurance: tests: NOT_RECORDED; latest recorded formal audit: PASS (reports/PHASE6_MISSING_PUBLISH_CAP_AUDIT_20260725.md); currency: NEEDS_AUDIT; artifacts retained: 34.
- Design state: changelog 0.7.20-36; poetics v1.
