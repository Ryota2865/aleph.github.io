...
- Assurance: tests: NOT_RECORDED; latest recorded formal audit: PASS (reports/PHASE6_BUDGET_SNAPSHOT_ISOLATION_AUDIT_20260725.md); currency: NEEDS_AUDIT; artifacts retained: 32.
- Design state: changelog 0.7.20-34; poetics v1.
