...
- Assurance: tests: NOT_RECORDED; latest recorded formal audit: PASS (reports/PHASE6_MISSING_POETICS_HISTORY_AUDIT_20260725.md); currency: NEEDS_AUDIT; artifacts retained: 36.
- Design state: changelog 0.7.20-38; poetics v1.
