...
- Assurance: tests: NOT_RECORDED; latest recorded formal audit: FAIL (reports/PHASE6_CURRENT_STATE_AUDIT_20260724_FAIL.md); currency: NEEDS_AUDIT; artifacts retained: 26.
- Design state: changelog 0.7.20-28; poetics v1.
