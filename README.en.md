...
- Assurance: tests: NOT_RECORDED; latest recorded formal audit: PASS (reports/PHASE6_POST_CAMPAIGN_CALIBRATION_AUDIT_20260726.md); currency: NEEDS_AUDIT; artifacts retained: 38.
- Design state: changelog 0.7.20-40; poetics v1.
