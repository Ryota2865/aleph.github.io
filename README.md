...
- 作品記録: 8作（w0008まで）、終端到達: 8作。
- 公開作品: 5作 — w0004「半呼吸」、w0005「床の硬さ」、w0006「灯のうしろ」、w0007「折り目」、w0008「暗い側」
- formal audit artifact: 16件。tests greenとformal audit判定は分離して表示する。
<!-- repository-snapshot:end -->

M0〜M8（探索・素材・構成・執筆・査読・擱筆・公開の閉ループ、実験スプリント、
公開判断の分離と測定器修理）と、採用済み解釈・replay計画のPhase 1〜3を
実装・正式独立監査PASS済み。設計者（Claude Fable 5）が契約
（受入テスト）を書き、施工エージェント
（Claude Code / Codex / pi / hermes）がクロス監査体制で実装する（PLAN §10・§12）。

- **統合ラン実績**: w0001〜w0008 を実LLMで完走。w0001〜w0003 は SHELVE、w0004〜w0008
  は PUBLISH。w0005/w0006では
