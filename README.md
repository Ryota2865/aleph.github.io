...
公開判断の分離と測定器修理）を実装・受入済み。設計者（Claude Fable 5）が契約
（受入テスト）を書き、施工エージェント
（Claude Code / Codex / pi / hermes）がクロス監査体制で実装する（PLAN §10・§12）。

- **統合ラン実績**: w0001〜w0006 を実LLMで完走。w0001〜w0003 は SHELVE、w0004
  「半呼吸」・w0005「床の硬さ」・w0006「灯のうしろ」は PUBLISH。w0005/w0006では
...
- **公開サイト**: `docs/`（GitHub Pages）。公開3作品に加え、制作過程、批評と応答、研究、
